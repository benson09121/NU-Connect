 ...
 *   GET    /venues/with-availability     — dedicated per-slot availability endpoint
...
// Dedicated per-slot availability endpoint (must be before any :id route)
router.get('/venues/with-availability', validateAzureJWT, ctrl.getVenuesAvailability);
