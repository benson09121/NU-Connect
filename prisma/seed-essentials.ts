...
async function main() {
  ...
  const rolePermPairs: [number, number][] = [
    ...
    [r(4), p(27)], [r(4), p(30)], [r(4), p(32)], [r(4), p(33)], [r(4), p(51)],
    // Adviser (role 2)
  ...
  //    Perm indices (1-based): 1,9,16,11,12,13,14,23,4,24,25,17,19,20,21,22,29,31,34,35,36,37,38,39,40,41,42,46,47,48,49,50,51
  // -------------------------------------------------------------------------
  console.log('  • rank permissions');
  const presidentRankPermIds = [1,9,16,11,12,13,14,23,4,24,25,17,19,20,21,22,29,31,34,35,36,37,38,39,40,41,42,46,47,48,49,50,51];
